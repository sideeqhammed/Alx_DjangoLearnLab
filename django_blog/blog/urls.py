...
urlpatterns = [
  ...
  path('post/<int:pk>/update/', views.BlogUpdateView.as_view(), name='blog_update'),
  path('post/<int:pk>/delete/', views.BlogDeleteView.as_view(), name='blog_delete'),
  path('post/<int:pk>/comment_list/', views.CommentListView.as_view(), name='comment_list'),
  path('post/<int:pk>/comment_create/', views.CommentCreateView.as_view(), name='comment_create'),
  path('post/<int:pk>/comment_update/', views.CommentCreateView.as_view(), name='comment_update'),
  path('post/<int:pk>/comment_delete/', views.CommentDeleteView.as_view(), name='comment_delete'),
]